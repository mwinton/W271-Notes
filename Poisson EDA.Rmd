...
round(resid_dev, 4)
```
Because the goodness of fit $\chi^2$ test is statistically significant, we reject the null hypothesis and conclude the model does not fit the data particularly well.  
