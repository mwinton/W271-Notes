---
title: "Likelihood Notes - Categorical Data"
...
\subsection{Maximum Likelihood and $\hat{\pi}$}
...
\subsection{Calculating log likelihood}
...
\subsection{Aside: Bernoulli (binary) or Binomial data give same results}
...
```
\newpage
\section{Odds Ratio and Confidence Interval}
...
\subsection{Confidence Interval for OR}
...
\section{Probability of Success and its Confidence Interval}
...
\subsection{Profile Likelihood Interval}
