...
*Observations:* not much pattern observed here.  The *lack of fit test* results are also displayed (only meaniningful for continuous variables, otherwise `NA`).  A large p-value means we cannot reject the null hypothesis that the model fits the data well.  Here, the p-value of ~0 indicates a lack of fit. (**TODO: confirm this interpretation.**)
