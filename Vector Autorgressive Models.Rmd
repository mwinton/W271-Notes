...
The statistically significant p-value tells us that we can reject the null hypothesis that they are not cointegrated, thus providing evidence that they are cointegrated.
